            ...
            <?php foreach ($publicPosts as $post): ?>
                <div class="flex justify-center m-2">
                    <div class="post bg-white p-6 rounded-xl shadow-md border border-gray-200 w-full">
                        ...
                        <img src="<?php echo htmlspecialchars($post['image']); ?>" alt="Post image" class="w-full h-48 object-cover mb-1 rounded-xl" />
                        <div class="flex flex-col justify-between h-28">
                            <p class="text-xs text-black hover:underline hover:cursor-pointer"><?php echo htmlspecialchars($post['creator_email']); ?></p>
