<div class=" w-auto rounded-xl ml-80 -mt-16">
    ...
    <div class="w-full">
        <div class="flex m-8">
            <h1 class="text-4xl mb-4 p-2 font-bold hover:underline hover:cursor-pointer">Posts de mes relations</h1>
            <a href="?page=create">
        ...
        <div id="all_public_posts" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mx-6">
            <?php foreach ($friendsPosts as $post): ?>
                    ...
                    <div class="post bg-white p-6 rounded-xl shadow-md border border-gray-200 w-full">
                        ...
                        <?php else: ?>
                            <button class="flex flex-col justify-center h-6 text-white px-4 py-4 rounded-xl shadow-sm border-2 border-gray-700 bg-gray-700 hover:opacity-100 text-sm mb-4 ">
                                <a class="font-bold tracking-wider">POST</a>
                            </button>
                        <?php endif; ?>
                        ...
                        <div class="flex flex-col justify-between h-28">
                            ...
                            <p class="text-sm text-gray-500 overflow-hidden h-20 truncate hover:cursor-pointer hover:underline">
                                <a href="?page=show_post&id_post=<?php echo $post['id_post']; ?>">
                                    Voir plus
                                </a>
                            </p>
                            <div class="flex justify-between items-center mt-4">
                                <div class="text-xl text-gray-500">
                                    <span class="mr-2"><?php echo $post['likes']; ?> likes</span>
                                    <span><?php echo $post['dislikes']; ?> dislikes</span>
                                </div>
                            </div>
                        </div>
                    </div>
